...
define("BASE_URL", "http://" . $_SERVER['HTTP_HOST'] . "/" . DOMINIO);
...
/**************************************** DATOS DEL EMAIL SMTP *****************************************/
define('EMAIL_USER', "programacioncodeunic@gmail.com");
define('EMAIL_PASSWORD', "51251451");
define('EMAIL_FROM', "programacioncodeunic@gmail.com");
define("EMAIL_NOMBRE", "SRP GESTION");
